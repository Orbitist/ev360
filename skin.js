...
// Pano2VR 5.2.5/15998
// Filename: simplex_EV.ggsk
// Generated Tue Nov 13 16:41:51 2018
...
function pano2vrSkin(player,base) {
	...
	this.addSkin=function() {
		...
		this._iframe_popup_file=document.createElement('div');
		this._iframe_popup_file.ggId="iframe_popup_file";
		this._iframe_popup_file.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		this._iframe_popup_file.ggVisible=false;
		this._iframe_popup_file.className='ggskin ggskin_container ';
		this._iframe_popup_file.ggType='container';
		hs ='';
		hs+='height : 80%;';
		hs+='left : 10%;';
		hs+='position : absolute;';
		...
		hs+='width : 80%;';
		hs+='pointer-events:none;';
		this._iframe_popup_file.setAttribute('style',hs);
		this._iframe_popup_file.style[domTransform + 'Origin']='50% 50%';
		me._iframe_popup_file.ggIsActive=function() {
			return false;
		}
		me._iframe_popup_file.ggElementNodeId=function() {
			return me.player.getCurrentNode();
		}
		this._iframe_popup_file.ggUpdatePosition=function (useTransition) {
		}
		this._iframe=document.createElement('div');
		this._iframe__text=document.createElement('div');
		this._iframe.className='ggskin ggskin_textdiv';
		this._iframe.ggTextDiv=this._iframe__text;
		this._iframe.ggId="iframe";
		this._iframe.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		this._iframe.ggVisible=true;
		this._iframe.className='ggskin ggskin_text ';
		this._iframe.ggType='text';
		hs ='';
		hs+='height : 100%;';
		hs+='left : -38px;';
		hs+='position : absolute;';
		...
		hs+='width : 100%;';
		hs+='pointer-events:auto;';
		this._iframe.setAttribute('style',hs);
		this._iframe.style[domTransform + 'Origin']='50% 50%';
		hs ='position:absolute;';
		hs+='cursor: default;';
		hs+='left: 0px;';
		hs+='top:  0px;';
		...
		hs+='padding: 0px 1px 0px 1px;';
		hs+='overflow: hidden;';
		this._iframe__text.setAttribute('style',hs);
		this._iframe__text.innerHTML="text";
		this._iframe.appendChild(this._iframe__text);
		...
		me._iframe.ggElementNodeId=function() {
			if ((this.parentNode) && (this.parentNode.ggElementNodeId)) {
				return this.parentNode.ggElementNodeId();
			}
			return me.player.getCurrentNode();
		}
		this._iframe.ggUpdatePosition=function (useTransition) {
		}
		this._iframe_popup_file.appendChild(this._iframe);
		this.divSkin.appendChild(this._iframe_popup_file);
		me._popup_video_file.ggVideoSource = 'media/';
		me._popup_video_file.ggVideoNotLoaded = true;
